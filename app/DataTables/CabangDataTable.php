...
class CabangDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (PermissionCommon::check('role.create')) {
            $button[] = Button::raw('<i class="fa fa-plus"></i> Tambah Cabang')->action('function() { create() }');
        }
        return $this->builder()
            ->parameters([
                'language' => [
