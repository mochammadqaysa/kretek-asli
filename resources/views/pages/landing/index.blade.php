          ...
          <div class="project-slider aos-init aos-animate" data-aos="fade">
            <div class="swiper-container js-project">
              <div class="swiper-wrapper">
                ...
                @php $image = $cb->img_path == '' ? asset('img/default-avatar.png') : asset('upload/' . $cb->img_path); @endphp
                <div class="swiper-slide">
                  <div class="project-slide">
                    <div class="project-slide__img"><img src="{{ $image }}" alt=""></div>
                    <div class="project-slide__hover">
                      <div class="project-slide__info">
                        <h3 class="project-slide__title">{{ $cb->nama }}</h3>
                        <div class="project-slide__descr">{{ $cb->alamat }}</div>
                      </div>
                      <div class="project-slide__btns"><a class="project-slide__btn" target="blank" href="{{ $cb->map_link }}"><i class="svg-image-btn-arrow"></i></a></div>
                    </div>
                  </div>
                </div>
                @endforeach
              ...
              <div class="contact-items row">
                <div class="col-xl-6 contact-item">
                  <div class="contact-info">
                    ...
                    <div class="contact-info__addr aos-init aos-animate" data-aos="fade"> Cabang yang terdekat dengan anda : <b><span id="nearest-branch">Mendeteksi lokasi... </span></b></div>
    ...
    <script>
      ...
      function formatDistance(km) {
          if (km < 1) {
              ...
              // Jika >= 1 km, tampilkan dalam km dengan 1 desimal
